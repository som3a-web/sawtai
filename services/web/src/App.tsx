...
const KnowledgeWorkspace = lazy(() => import("./features/knowledge/KnowledgeWorkspace").then((module) => ({ default: module.KnowledgeWorkspace })));
...
export function App() {
  ...
  const nav = useMemo(() => user ? [
    ...
    { id: "knowledge" as Page, icon: "▤", label: locale === "ar" ? "مصادر المعرفة" : "Knowledge", permission: "doc:read" },
